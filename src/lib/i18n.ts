...
trustDesc: 'How much they trust each other.',
  ...
  narrator: 'Narrator',
  narratorPlaceholder: 'Text with the Narrator... (or use /random to generate a scenario)',
  send: 'Send',
...
const vi: I18n = {
  ...
  leisurelyChatDesc: 'Độ trễ là thời gian nhập tin nhắn của nhân vật',
  deepInteraction: 'Tương tác sâu',
  deepInteractionDesc: 'Nội dung phát triển ngoài chủ đề ban đầu.',
  ...
  narratorPlaceholder: 'Nhắn tin cho Narrator.. (hoặc nhập /random để tạo kịch bản ngẫu nhiên)',
  send: 'Gửi',
